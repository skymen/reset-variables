  ...
  Acts: {
    ...
    */
      ...
      params: [
        {
          id: "variableName",
          name: "Variable Name",
          desc: "The name of the variable to reset",
          type: "string",
          value: "",
        },
      ],
      listName: "Reset Global Variable By Name",
      displayText: "Reset global variable by name [i]{0}[/i]",
    ...
    ResetBooleanVariable: {
      ...
      listName: "Reset Boolean Variable",
      displayText: "Reset boolean variable [i]{0}[/i]",
